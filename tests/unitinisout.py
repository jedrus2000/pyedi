...
class InmessageJson(unittest.TestCase):
    ...
    def testjson01(self):
        ...
        inn1 = inmessage.parse_edi_file(
            filename=filein, editype="json", messagetype="articles"
        )
        inn2 = inmessage.parse_edi_file(
            filename=filecomp, editype="xml", messagetype="articles"
        )
    ...
    def testjsoninvoic01(self):
        ...
        inn1 = inmessage.parse_edi_file(
            filename=filein, editype="json", messagetype="invoic"
        )
        inn2 = inmessage.parse_edi_file(
            filename=filecomp, editype="xml", messagetype="invoic"
        )
        self.failUnless(utilsunit.comparenode(inn1.root, inn2.root))
    ...
    def testinisoutjson02(self):
        ...
        inn = inmessage.parse_edi_file(
            editype="json", messagetype="jsoninvoic", filename=filein
        )
    ...
    def testinisoutjson04(self):
        ...
        inn2 = inmessage.parse_edi_file(
            filename=filein, editype="json", messagetype="jsoninvoic"
        )
        self.failUnless(utilsunit.comparenode(inn1.root, inn2.root))
...
class TestInmessage(unittest.TestCase):
    ...
    def testedifact0403(self):
        ...
        for in1node, in2node, in3node in zip(
            ...
            self.failUnless(
                utilsunit.comparenode(in1node.root, in2node.root), "compare"
            )
            self.failUnless(
                utilsunit.comparenode(in1node.root, in3node.root), "compare"
            )
...
class Testinisoutinh(unittest.TestCase):
    ...
    def testidoc01(self):
        ...
        inn = inmessage.parse_edi_file(
            editype="idoc", messagetype="WP_PLU02", filename=filenamein
        )
        out = outmessage.outmessage_init(
            editype="idoc",
...
class Testinisoutx12(unittest.TestCase):
    def testx12_01(self):
        ...
        self.assertEqual(
            inn.ta_info["frompartner"], "11111111111", "ISA partner without spaces"
        )
        self.assertEqual(
            inn.ta_info["topartner"], "22222222222", "ISA partner without spaces"
        )
        out = outmessage.outmessage_init(
            editype="x12",
